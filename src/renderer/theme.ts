/**
 * OCO Design Tokens — Dual theme (dark + light)
...
const darkColors = {
  ...
  containerBg: '#212121',
  containerBgCollapsed: '#1a1a1a',
  containerBorder: '#3a3a3a',
  ...
  statusComplete: '#10a37f',
  statusCompleteBg: 'rgba(16, 163, 127, 0.1)',
  statusError: '#ef4146',
  statusErrorBg: 'rgba(239, 65, 70, 0.08)',
  statusDead: '#ef4146',
  ...
  permissionAllowBg: 'rgba(16, 163, 127, 0.1)',
  permissionAllowHoverBg: 'rgba(16, 163, 127, 0.22)',
  permissionAllowBorder: 'rgba(16, 163, 127, 0.25)',
  ...
  permissionDeniedBorder: 'rgba(239, 65, 70, 0.3)',
  permissionDeniedHeaderBorder: 'rgba(239, 65, 70, 0.12)',
} as const

const lightColors = {
  // Container (glass surfaces)
  containerBg: '#ffffff',
  containerBgCollapsed: '#f7f7f8',
  ...
  statusCompleteBg: 'rgba(16, 163, 127, 0.1)',
  statusError: '#ef4146',
  statusErrorBg: 'rgba(239, 65, 70, 0.06)',
  statusDead: '#ef4146',
  statusPermission: '#10a37f',
...
/** Convert camelCase token name to --oco-kebab-case CSS custom property */
